...
<body>
    ...
    <div class="container section" id="politica-cookies">
        <div class="row">
            <div class="col-xs-12">
                ...
                <p>Si tiene dudas sobre esta política de cookies, puede contactar con nosotros en <a href="mailto:info@cuentavidas.com">info@cuentavidas.com</a>.</p>
            </div>
        </div>
    </div>
